...
const calculateAttendanceStats = async (attendance) => {
    ...
    let totalHours = latestAttendance.punchTime ? latestAttendance.punchTime.reduce((sum, p) => {
    ...
    let breakHours = latestAttendance.breakTime ? latestAttendance.breakTime.reduce((sum, b) => {
