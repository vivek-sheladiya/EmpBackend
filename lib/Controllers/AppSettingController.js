...
const updateSetting = async (req, res) => {
  try {
    const { officeStartTime, officeEndTime, breakDuration, screenshotTime, showScreenShot, isTakeScreenShot } = req.body;
    ...
    settings.screenshotTime = screenshotTime;
    settings.showScreenShot = showScreenShot;
    settings.isTakeScreenShot = isTakeScreenShot;
