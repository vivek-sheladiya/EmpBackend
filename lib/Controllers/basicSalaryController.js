...
//         const newReports = [];
//         const userIdString = allBasicSalaries[0]?.user?._id;
//         console.log("userId:", userIdString);
//         const userId = userIdString.toString();
...
//                         { $set: reportData }
//                     );
//                     console.log(`Updated report for user: ${item.user.fullName} for ${startOfMonth.format("YYYY-MM-DD")}`);
//                 } else {
...
//             console.log("New reports created:", createdReports);
//         }
//         console.log("newReports", createdReports);
