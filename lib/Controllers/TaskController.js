...
const {generateRandomId, handleError} = require("../utils/utils");
...
const updateTask = async (req, res) => {
  try {
    ...
    if (id) {
      ...
      // if (updateData.taskStartDate) {
      //   updateData.taskStartDate = dayjs(updateData.taskStartDate).format('DD-MM-YYYY hh:mm:ss A');
      // }
      //
      // if (updateData.taskEndDate) {
      //   updateData.taskEndDate = dayjs(updateData.taskEndDate).format('DD-MM-YYYY hh:mm:ss A');
      // }
