...
const chatHandler = async (req, res) => {
    ...
    try {
        ...
        switch (action) {
            ...
            case 'sendMessage': {
                const { roomId, message, attachments, messageType = "text" } = req.body;
                if (!roomId) {
                    return res.status(400).json({
                        success: false,
                ...
                return await sendMessageHandler(req, res, roomId, userId, message, attachments, messageType);
            }
...
const sendMessageHandler = async (req, res, roomId, sender, message, attachments, messageType) => {
...
module.exports = { chatHandler, getRooms, getRoomMessagesWithExtraData, chatUpdates, markMessagesAsReadHandler, getRoomWithMessages };