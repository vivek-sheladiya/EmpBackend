...
const addLeave = async (req, res) => {
    try {
        ...
        if (leaveType === leaveLabelKeys.fullDay) {
            try {
                const validatedData = validateFullDayLeave({ dayType: dayType, startDate: req.body.startDate, endDate: req.body.endDate, limit: settings.appSettings.monthlyMaxPaidLeave, leaveCategory });
