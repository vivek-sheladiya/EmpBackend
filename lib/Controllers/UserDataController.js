  ...
  try {
    ...
    if (keyPressCount) {
      if (attendance.keyPressCount !== null) {
        attendance.keyPressCount = Numbr(attendance.keyPressCount) + Number(keyPressCount);
      } else {
    ...
    if (mouseEventCount) {
      if (attendance.mouseEventCount !== null) {
        attendance.mouseEventCount = Numbr(attendance.mouseEventCount) + Number(mouseEventCount);
      } else {
