  ...
  try {
    ...
    if (keyPressCount) {
      if (attendance.keyPressCount !== null) {
        attendance.keyPressCount = attendance.keyPressCount + keyPressCount;
      } else {
        attendance.keyPressCount = keyPressCount;
      }
    }

    if (mouseEventCount) {
      if (attendance.mouseEventCount !== null) {
        attendance.mouseEventCount = attendance.mouseEventCount + mouseEventCount;
      } else {
        attendance.mouseEventCount = mouseEventCount;
      }
    }
