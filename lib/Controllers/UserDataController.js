...
const calculateAttendanceStats = async (attendance) => {
  ...
  const breakDuration = settings.breakDuration * 60 * 1000;
  const totalOfficeHourMilli = officeHoursEnd - officeHoursStart - breakDuration;
...
const updateTask = async (req, res) => {
  try {
    ...
    var historyChanges = fieldsToCheck
    ...
    // console.log("flkgj", updateData.taskHistory);
