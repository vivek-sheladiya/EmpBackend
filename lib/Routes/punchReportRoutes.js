...
const { storePunchReports, getPunchReports, deletePunchReports, updatePunchReports, salaryReportsGenerate } = require("../Controllers/punchReportController");
...
router.put('/updatePunchReports/:_id', ensureAuthenticated, updatePunchReports);
