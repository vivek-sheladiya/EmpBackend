...
const { getAllUsers, deleteUser, getUserByEmail, getUserByName, addUsers, getUserById, addAttendance, getTodayAttendance, getEmployeeDashboardData, getAdminDashboardData, getUserWiseAttendanceData, deleteImage } = require('../Controllers/UserDataController');
